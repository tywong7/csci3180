...
class Map(object):
    ...
    def initialize_All(self):
        ...
        for i in range (self._total_Num):
            ...
            if i<self._m:
                ...
                self._lands[pos.X][pos.Y].Occupied_obj=Potion(pos.X,pos.Y,i-self._m-self._e-self._w,self)
                self._teleportable_obj.append(self._lands[pos.X][pos.Y].Occupied_obj)
    ...
    def decrease_Num_Of_Potions(self):
        self._num_Of_Potions-=1
    @property
